  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "prompts", label: "promptMgmt" },
			{ key: "prompt-edit", label: "promptEdit" },
			{ key: "prompt-review", label: "promptReview" },
			{ key: "prompt-publish", label: "promptPublish" },
      { key: "workflow-view", label: "workflowView" },
      { key: "workflow-edit", label: "workflowEdit" },
      { key: "workflow-review", label: "workflowReview" },
      { key: "workflow-publish", label: "workflowPublish" },
